            ...
            <div class="media-list media-list-hover mt-20">
                ...
                <div class="media py-10 px-0">
                    <a class="avatar avatar-lg status-danger" href="#">
                        <img src="<?= base_url('template') ?>/images/avatar/2.jpg" alt="...">
                    </a>
                    <div class="media-body">
                        <p class="font-size-16">
                ...
                <div class="media py-10 px-0">
                    <a class="avatar avatar-lg status-warning" href="#">
                        <img src="<?= base_url('template') ?>/images/avatar/3.jpg" alt="...">
                    </a>
                    <div class="media-body">
                        <p class="font-size-16">
                ...
                <div class="media py-10 px-0">
                    <a class="avatar avatar-lg status-primary" href="#">
                        <img src="<?= base_url('template') ?>/images/avatar/4.jpg" alt="...">
                    </a>
                    <div class="media-body">
                        <p class="font-size-16">
                            <a class="hover-primary" href="#"><strong>Evan</strong></a>
...
<script src="<?= base_url('template') ?>/assets/vendor_components/easypiechart/dist/jquery.easypiechart.js"></script>
<script src="<?= base_url('template') ?>/assets/vendor_components/apexcharts-bundle/irregular-data-series.js"></script>
<script src="<?= base_url('template') ?>/assets/vendor_components/apexcharts-bundle/dist/apexcharts.js"></script>

<!-- Sunny Admin App -->
<script src="<?= base_url('template/main') ?>/js/template.js"></script>
<script src="<?= base_url('template/main') ?>/js/pages/dashboard.js"></script>
