             ...
             <div class="ulogo">
                 <a href="<?= base_url() ?>">
                     ...
                     <div class="d-flex align-items-center justify-content-center">
                         <img src="<?= base_url('template') ?>/images/logo-dark.png" alt="">
                         <h3><b>Candy</b> Admin</h3>
                     </div>
                 </a>
             </div>
         </div>
         ...
         <ul class="sidebar-menu" data-widget="tree">
             ...
             <li class="treeview">
                 ...
                 <ul class="treeview-menu">
                     <li><a href="chat.html"><i class="ti-more"></i>Data Guru</a></li>
                     <li><a href="calendar.html"><i class="ti-more"></i>Data Mata Pelajaran</a></li>
                 </ul>
             </li>
             <li class="treeview">
                 <a href="#">
